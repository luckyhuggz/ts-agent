...
export async function runShellCommand(
  request: DesktopShellCommandRequest,
  ...
  return new Promise<DesktopShellCommandResponse>((resolvePromise, rejectPromise) => {
...
function getShellSpec(command: string): { command: string; args: string[]; label: string } {
